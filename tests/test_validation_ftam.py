...
class TestFTAM(unittest.TestCase):
    ...
    def test_02_machine_etat(self):
        ...
        self.assertEqual(
            res.get(K_CODE),
            ERREUR_DROITS,
            "Le système n'a pas bloqué la transition d'état illégale.",
        )
    ...
    def test_03_controle_acces_roles(self):
        ...
        try:
            ...
            self.assertEqual(
                res.get(K_CODE),
                ERREUR_DROITS,
                "Le profil invité a pu outrepasser ses droits.",
            )
    ...
    def test_04_transfert_integral(self):
        ...
        res_up = self.client.envoyer_requete(
            F_WRITE, {"nom": nom_test, "data": bloc_b64, "fin": True}
        )
    ...
    def test_05_mecanisme_reprise(self):
        ...
        self.journaliser_echange(
            "Interrogation du contexte de reprise (F-RECOVER)", res
        )
    ...
    def test_07_gestion_dynamique_permissions(self):
        ...
        self.journaliser_echange(
            "Mise à jour dynamique des permissions (F-SET-PERMISSIONS)", res
        )
